...
import AOS from 'aos';
import gambar from '../public/img/undraw_progressive_app_m9ms.png'
console.log(gambar)
const Home: NextPage = function () {
  useEffect(() => {
    AOS.init()
    console.log('aos', AOS.init())
  }, [])
  return (
    <>
     {/* <!-- Navbar --> */}
            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ms-auto text-lg gap-lg-0 gap-2">
                        ...
                        <li className="nav-item my-auto">
                            <a className="nav-link" href="#">Kelas</a>
                        </li>
                        <li className="nav-item my-auto">
            ...
            <div className="row gap-lg-0 gap-5">
                <div className="col-lg-6 col-12 my-auto">
                    ...
                    <h1 className="header-title color-palette-1 fw-bold">
                       Pengalaman Baru <span className="d-sm-inline d-none">Belajar </span><span className="d-sm-none d-inline">a
                        </span><span className="underline-blue">Coding</span> <br className="d-sm-block d-none"/> <span
                            className="underline-blue">Bersama</span> 
                    </h1>
                    <p className="mt-30 mb-40 text-lg color-palette-1">Kami berusaha menyediakan materi yang berkualitas<br
                            className="d-md-block d-none"/>dan mudah dipahami.
                    </p>
                    <div className="d-flex flex-lg-row flex-column gap-4">
                        <a className="btn btn-get text-lg text-white rounded-pill" href="#feature" role="button">Mulai Sekarang</a>
                ...
                <div className="col-lg-6 col-12 d-lg-block d-none">
                    <div className="d-flex justify-content-lg-end justify-content-center me-lg-5">
                        <div className="position-relative" data-aos="zoom-in">
                            <img src={gambar.src} style={{"width": "100%"}} className="img-fluid" alt="fggfg"/>
    ...
    <section id="feature" className="feature pt-50 pb-50">
        <div className="container-fluid">
            <h2 className="text-4xl fw-bold color-palette-1 text-center mb-30">Keunggulan<br/> Learning by Code
            </h2>
            <div className="row gap-lg-0 gap-4" data-aos="fade-up">
                <div className="col-lg-4">
                    <div className="card feature-card border-0">
                        ...
                        <p className="fw-semibold text-2xl mb-2 color-palette-1">1. Terjangkau </p>
                        <p className="text-lg color-palette-1 mb-0">Tersedia kelas yang gratis</p>
                    </div>
                </div>
                <div className="col-lg-4">
                    <div className="card feature-card border-0">
                        ...
                        <p className="fw-semibold text-2xl mb-2 color-palette-1">2. Fleksibel</p>
                        <p className="text-lg color-palette-1 mb-0">Bisa belajar dimana saja dan kapanpun.</p>
                    </div>
                </div>
                <div className="col-lg-4">
                    <div className="card feature-card border-0">
                        ...
                        <p className="fw-semibold text-2xl mb-2 color-palette-1">3. Studi Kasus</p>
                        <p className="text-lg color-palette-1 mb-0">Materi berorentasi pada<br/>
                           studi kasus.</p>
                    </div>
                </div>
            </div>
    ...
    <section className="featured-game pt-50 pb-50">
        <div className="container-fluid">
            <h2 className="text-4xl fw-bold color-palette-1 mb-30">Kelas Kami<br/>
            </h2>
        ...
        <div className="container-fluid">
            <div className="d-flex flex-lg-row flex-column align-items-center justify-content-center gap-lg-0 gap-4">
                <div className="me-lg-35">
                    <p className="text-4xl text-lg-start text-center color-palette-1 fw-bold m-0">290</p>
                    <p className="text-lg text-lg-start text-center color-palette-2 m-0">Artikel</p>
                </div>
                <div className="vertical-line me-lg-35 ms-lg-35 d-lg-block d-none"></div>
                <div className="horizontal-line mt-6 mb-6 me-lg-35 ms-lg-35 d-lg-none d-block"></div>
                <div className="me-lg-35 ms-lg-35">
                    <p className="text-4xl text-lg-start text-center color-palette-1 fw-bold m-0">125</p>
                    <p className="text-lg text-lg-start text-center color-palette-2 m-0">Siswa</p>
                </div>
                <div className="horizontal-line mt-6 mb-6 me-lg-35 ms-lg-35 d-lg-none d-block"></div>
                <div className="vertical-line me-lg-35 ms-lg-35 d-lg-block d-none"></div>
                <div className="me-lg-35 ms-lg-35">
                    <p className="text-4xl text-lg-start text-center color-palette-1 fw-bold m-0">100</p>
                    <p className="text-lg text-lg-start text-center color-palette-2 m-0">Alumni</p>
                </div>
                <div className="horizontal-line mt-6 mb-6 me-lg-35 ms-lg-35 d-lg-none d-block"></div>
                <div className="vertical-line me-lg-35 ms-lg-35 d-lg-block d-none"></div>
                <div className="me-lg-35 ms-lg-35">
                    <p className="text-4xl text-lg-start text-center color-palette-1 fw-bold m-0">4.7</p>
                    <p className="text-lg text-lg-start text-center color-palette-2 m-0">Rating</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div className="container-xxl container-fluid">
            <div className="row align-items-center px-lg-5 mx-auto gap-lg-0 gap-4">
                ...
                <div className="col-lg-5 col-12 ps-lg-60">
                    <div className="">
                        <h2 className="text-4xl fw-bold color-palette-1 mb-30">Programmer Cilik<br/>
                        </h2>
