        ...
        <main className="main-wrapper">
            <div className="ps-lg-0">
                ...
                <div className="top-up-categories mb-30">
                    <p className="text-lg fw-medium color-palette-1 mb-14">Kelas yang diikuti</p>
                ...
                <div className="latest-transaction">
                    <p className="text-lg fw-medium color-palette-1 mb-14">Riwayat Transaksi</p>
                                ...
                                <tr className="align-middle">
                                    <th scope="row">
                                        <img className="float-start me-3 mb-lg-0 mb-3" src="/assets/img/overview-1.png"
                                            width="80" height="60" alt="overview"/>
